                                 ...
                                 {.name          = "mesh",
                                  ...
                                  .bind_textures = any_array_create_from_raw(
                                      (void *[]){
                                          ...
                                          GC_ALLOC_INIT(bind_tex_t,
                                              {.name = "tex_albedo", .file = "3d/textures/Camera_01_body_diff_4k.png"}),
                                          GC_ALLOC_INIT(bind_tex_t,
                                              {.name = "tex_metallic", .file = "3d/textures/Camera_01_body_metallic_4k.png"}),
                                          GC_ALLOC_INIT(bind_tex_t,
                                              {.name = "tex_roughness", .file = "3d/textures/Camera_01_body_roughness_4k.png"}),
                                      },
                                      4)}),
                         },
                         1)}),
                                 ...
                                 {.name            = "mesh",
                                  ...
                                  .texture_units = any_array_create_from_raw(
                                      (void *[]){
                                          ...
                                          GC_ALLOC_INIT(tex_unit_t,
                                              {.name = "tex_albedo", .link = "tex_albedo"}),
                                          GC_ALLOC_INIT(tex_unit_t,
                                              {.name = "tex_metallic", .link = "tex_metallic"}),
                                          GC_ALLOC_INIT(tex_unit_t,
                                              {.name = "tex_roughness", .link = "tex_roughness"}),
                                      },
                                      4),
